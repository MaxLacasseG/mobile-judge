                ...
                <Router>
                    <div className="App">
                        <Switch>
                            ...
                            <AdminRoute exact path="/admin/finale/*/vue-projets" component={FinalViewProjects} />
                            <AdminRoute exact path="/admin/finale/*/vue-juges" component={FinalViewJudges} />
                            <AdminRoute exact path="/admin/finale/*/vue-periodes" component={FinalViewPeriods} />
                            <AdminRoute exact path="/admin/finale/*/infos" component={FinalViewInfos} />
