                ...
                <div className="p-3">
                    ...
                    <form onSubmit={this.OnSubmit}>
                        <div className="row text-center">
                            <div className="col">
                                <label htmlFor="pairingJsonImport" className="btn btn-accent2 btn-lg btn-block">
                                ...
                                />
                                <small>
                                    <i className="fas fa-exclamation-circle fa-sm" /> Veuiller choisir le fichier .txt depuis le logiciel Répartition
                                    dans le dossier version
                                </small>
                            </div>
                        </div>
                        <hr />
                        ...
                        <div className="row">
                            <div className="col-md-6 offset-3">
                                ...
                                />
                                <p>
                                    <small>Attention, ceci risque réinitialise tous les changements manuels effectués</small>
                                </p>
                            </div>
                        </div>
                    </form>
