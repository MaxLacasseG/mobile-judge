...
class FinalViewProjects extends Component {
    ...
    componentDidMount = () => {
        ...
        window.addEventListener("load", this.InitializeTooltip, false);
    };
    ...
    render() {
        ...
        const projectsList = projects.map(project => {
            const attributionInfos = isEmpty(final.pairing) ? {} : final.pairing.pairingByProjects[project.number];
                ...
                <Fragment key={project.projectId}>
                    <div className="projectsListItem row" data-projectrow={project.number}>
                        ...
                        <div className="col-md-3 row">
                            ...
                            <div className="col-md">{project.information.projectInformation.title}</div>
                            <div className="col-md-1">{this.FormatCategory(project.information.projectInformation.category, true)}</div>
                            <div className="col-md-1">{this.FormatType(project.information.projectInformation.type, true)}</div>
