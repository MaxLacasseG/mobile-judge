...
class FinalViewExportation extends Component {
    ...
    CalculateProjectResults = (projectNumber, projectResults) => {
        ...
        const resultArray = Object.keys(projectResults)
            .filter(key => {
                return projectResults[key].total !== undefined && projectResults[key].total !== null;
            })
            .map(key => {
    ...
    FlipIconDirection = elem => {
        ...
        elem.dataset.direction === 1 ? elem.classList.add("sort-up") : elem.classList.add("sort-down");
    };
    ...
    render() {
        ...
        const results = isEmpty(this.props.final.selectedFinal.results) ? [] : this.props.final.selectedFinal.results;
                    ...
                    <div className="row w-50 mx-auto mt-5">
                        ...
                        <div className="row my-3 col-12">
                            <div className="mx-auto text-center">
                                ...
                                >
                                    <span className="text-uppercase font-weight-bold">Mettre à jour le classement</span>
                                </button>
                            </div>
                        </div>
                        <div className="row my-3 col-12 border-bottom pb-4">
                            <div className="mx-auto text-center">
                                <button type="button" className="btn btn-reseau btn-success btn-block p-3" onClick={this.MakeCSVFile}>
                                    <span className="text-uppercase font-weight-bold">Exporter en CSV</span>
                                </button>
                            </div>
                        </div>
