                ...
                return (
                    ...
                    >
                        ...
                        <div className="col-md-2">
                            <span className="">
                                <strong>Période {String.fromCharCode(64 + projects[key].period)}</strong>
                            </span>
                        </div>
                        <div className="col">
                            <Link
                                to={{
                                    ...
                                    state: {
                                        ...
                                        results: this.CheckExistingResult(projects[key].project, this.props.auth.user.number, results)
                                            ? this.ImportResults(projects[key].project, this.props.auth.user.number, results)
                                            : {}
                                    }
                                }}
                            >
            ...
            <div className="row">
                <div className="col-12 py-2">
                    ...
                    <p className="lead py-3 text-center">
                        Merci{" "}
                        <strong>
                            {gender === "F" ? "Mme" : gender === "M" ? "M." : null} {firstName} {lastName}{" "}
                        </strong>
                ...
                <div className="col-12">
                    <p>
                        Ci-dessous sont les projets, affichés par période de jugement, que vous aurez à juger en tant que{" "}
                        <strong>juge no {number}</strong>.
                    </p>
                    <p>
                        Les projets dont le jugement est incomplet sont affichés <strong>en orange</strong>.
                    </p>
                    <p>
                        Les projets dont le jugement est complet sont affichés <strong>en vert</strong>.
                    </p>
                    <p>Vous pouvez modifier un jugement, même s'il est complet, tant que le processus de jugement n'est pas terminé.</p>
                </div>
            </div>
        );
