...
import { highExperimentationGrid, highschoolConceptionGrid, highVulgarisationGrid } from "../../../enums/grids";
...
class EvaluationGrid extends Component {
    ...
    componentDidUpdate = (prevProps, prevState) => {
        if (prevProps.project.selectedProject !== this.props.project.selectedProject && !isEmpty(this.props.project.selectedProject)) {
            this.setState(
                {
    ...
    SaveResults = () => {
        ...
        const results = this.state.results;
        if (isEmpty(finalId) || isEmpty(judgeNumber) || isEmpty(projectNumber) || isEmpty(period) || isEmpty(results)) {
        ...
        this.props.SaveResult(finalId, judgeNumber, projectNumber, period, results, total, isComplete, this.props.history);
    };
            ...
            <Fragment>
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 mx-auto text-center">
                            Type de projet:
                            {project && this.FormatType(project.information.projectInformation.type)}
                        </div>
                        <div className="col-md-8 mx-auto text-center">
                            Catégorie:
                            {project && this.FormatCategory(project.information.projectInformation.category)}
                        </div>
                    </div>
                    {sections}
                    <div className="row">
