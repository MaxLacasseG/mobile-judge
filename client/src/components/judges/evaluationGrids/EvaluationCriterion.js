            ...
            return (
                <div className="row my-2 py-2" key={index}>
                    <div className="col-md-12 row">
                        ...
                        <div className={classnames("col-9", { "criterion-check": this.state[criterion.id] })}>{criterion.description}</div>
                    ...
                    <div className="col-md-12">
                        <EvaluationButtonGroup name={criterion.name} id={criterion.id} OnCompleteCriterion={this.OnCompleteCriterion} />
                    </div>
                </div>
            );
        });
