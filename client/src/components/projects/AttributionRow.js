...
class AttributionRow extends Component {
    ...
    CheckJudgmentStatus = (projectNumber, judgeNumber) => {
        ...
        if (results === undefined || isEmpty(results[projectNumber]) || isEmpty(results[projectNumber][judgeNumber])) return false;
    ...
    CheckJudgeAmount = () => {
        ...
        console.log(
            ...
            this.props.minJudges,
            judgeNumber,
            judgeNumber != this.props.minJudges ? false : true
        );
