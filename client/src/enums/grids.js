			...
			subsections: [
				{
					...
					criterions: [
						...
						},
						{
							id: "1C",
							description:
								"Recherche d'informations et identification des contraintes",
							percentage: 3
						},
						{
							id: "1D",
				...
				},
				{
					...
					criterions: [
						...
						},
						{
							id: "2C",
							description:
								"Apparence (fini du prototype, robustesse, qualités artisanales",
							percentage: 2
						}
					]
				},
				...
				},
				{
					...
					criterions: [
						...
						},
						{
							id: "4C",
							description:
								"Justification de l'ampleur de la solution par rapport aux objectifs initiaux",
							percentage: 5
						}
					]
				}
				...
				},
				{
					...
					criterions: [
						...
						},
						{
							...
							description: "Clarté",
							notes:
								"Ordre et lisibilité des éléments de présentation de façon à faciliter le suivi de l'exposé",
							percentage: 5
						},
						{
							id: "6C",
							description:
								"Qualité de la langue écrite et de la terminologie employée",
							percentage: 2
						}
					]
				},
				{
					...
					criterions: [
						...
						},
						{
							...
							notes:
								"Bibliographie conforme aux sources d'information consultées pour l'ensemble du projet",
							percentage: 4
						}
					]
				}
			...
			subsections: [
				...
				},
				{
					...
					criterions: [
						...
						{
							id: "2B",
							description: "Description du protocol expérimental",
							percentage: 4
						},
						{
							id: "2C",
							description:
								"Choix et utilisation adéquate des instruments scientifiques",
							percentage: 2
						},
						{
							id: "2D",
							...
							notes:
								"Expériences en laboratoires ou manipulations.\nConsignation des observations données.",
							percentage: 12
						}
					]
				},
				...
				},
				{
					...
					criterions: [
						...
						},
						{
							id: "4B",
							description:
								"Recommandations, suggestions de suites possibles, mise en perspective et présentation des applications",
							percentage: 3
						}
					]
				}
